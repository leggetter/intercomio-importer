...
Importer.prototype.loadPractices = function( resolve, reject ) {
  if( !this.options.practiceCSVPath ) {
    console.log( 'No Practice CSV path supplied. Skipping.' );
    resolve( [] );
  }
  else {
...
Importer.prototype.loadLocums = function( resolve, reject ) {
  ...
  if( !this.options.locumCSVPath ) {
    console.log( 'No Locum CSV path supplied. Skipping.' );
    resolve( [] );
  }
  else {
